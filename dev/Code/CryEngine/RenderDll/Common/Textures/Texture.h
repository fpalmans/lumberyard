...
public:
    ...
    virtual void GenerateMipMaps(bool bSetOrthoProj = false, bool bUseHW = true, bool bNormalMap = false) override;
    void RT_GenerateMipMaps(bool bSetOrthoProj = false, bool bUseHW = true, bool bNormalMap = false);
