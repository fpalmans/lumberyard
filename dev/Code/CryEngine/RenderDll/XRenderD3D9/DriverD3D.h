...
#if !defined(NULL_RENDERER) && (defined (WIN32) || defined(WIN64) || defined(DURANGO) || defined(ORBIS) || defined(APPLE) || defined(LINUX))
...
public:
    ...
    virtual int GetOcclusionBuffer(uint16* pOutOcclBuffer, int32 nSizeX, int32 nSizeY, Matrix44* pmViewProj, Matrix44* pmCamBuffer);
...
#include "../Common/FencedIB.h"
#include "../Common/FencedVB.h"
